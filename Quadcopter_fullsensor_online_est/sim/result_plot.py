...
# Plot Estimated Mass result
    ...
    plt.annotate(show_min, xytext=(steps - 150, Mass_his[-1] + 0.003), xy=(steps, Mass_his[-1]),fontsize=20)
...
# Plot Estimated Inertia Matrix result
    ...
    plt.annotate(show_min, xytext=(steps - 150, Ixx_his[-1] + 0.00003), xy=(steps, Ixx_his[-1]),fontsize=20)
    ...
    plt.annotate(show_min, xytext=(steps - 150, Iyy_his[-1] + 0.00003), xy=(steps, Iyy_his[-1]),fontsize=20)
    ...
    plt.annotate(show_min, xytext=(steps - 150, Izz_his[-1] - 0.00004), xy=(steps, Izz_his[-1]),fontsize=20)
...
# plot result
    ...
    plt.ylabel('Euler angle', fontsize=20)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
