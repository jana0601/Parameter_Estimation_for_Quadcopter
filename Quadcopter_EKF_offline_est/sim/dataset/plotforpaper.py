...
plt.plot(steps6[:830], Ixx_his6[:830], color="yellow", linestyle="--", linewidth=2.0, label='Simulation 6')
...
plt.plot(steps6[:830], Iyy_his6[:830], color="yellow", linestyle="--", linewidth=2.0, label='Simulation 6')
...
plt.plot(steps6[:830], Izz_his6[:830], color="yellow", linestyle="--", linewidth=2.0, label='Simulation 6')
...
plt.plot(steps6, Mass_his6, color="yellow", linestyle="--", linewidth=2.0, label='Simulation 6')
